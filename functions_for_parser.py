...
# The purpose of this code is to provide additional functions to a 
...
# Also see: https://github.com/shchurch/Insect_Egg_Evolution
...
# Packages used by the PDFMiner importer:
...
# In addition to the python packages listed above, this also requires
# that terminal-notifier also be intalled for generating MacOS notifications.
